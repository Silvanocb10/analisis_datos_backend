...
# Permitir conexión desde cualquier origen (necesario para Hugging Face)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Permite todos los orígenes (frontend incluido)
...
# =============================
# ENDPOINT: EXPORTAR RESULTADOS A BD
# =============================
...
# =============================
# ENDPOINT RAÍZ (verificación Hugging Face)
# =============================
@app.get("/")
def root():
    return {"message": "Backend funcionando correctamente en Hugging Face 🚀"}
